...
## Name of the styleguide: `webapp-01-industrialtechnical_latte`

Use the above name in `spawn_agent` if you want to pass it to subagents.

# Industrial Technical Web Dashboard - Catppuccin Latte Style Guide
...
A light-mode industrial dashboard built on Catppuccin Latte neutrals (#EFF1F5, #E6E9EF) with a single amber accent (#DF8E1D). The design preserves the control-panel and terminal personality of the original system through pervasive monospace typography (JetBrains Mono), numbered navigation sequences, and ALL-CAPS labeling with deliberate letter-spacing. Space Grotesk headlines provide geometric contrast. Suited for analytics platforms, developer tools, fintech dashboards, and data-intensive enterprise applications that need a bright surface theme.
...
- **Structure:** Zero corner radius throughout. 1px borders (#9CA0B0) as the primary structural device. Left-edge accent borders (#DF8E1D) mark active states and emphasis.
- **Color:** Neutral light foundation from Catppuccin Latte with a single amber accent (#DF8E1D) reserved for active states, CTAs, and charts. Semantic colors (green/red/blue) are used only for status communication.
...
`industrial` - `technical` - `light-mode` - `monospace` - `catppuccin-latte` - `amber-accent` - `data-dashboard` - `developer` - `numbered-nav` - `enterprise`

---

## Color System

The design uses Catppuccin Latte's neutral ladder for depth and hierarchy, reserving amber for emphasis. Semantic colors appear only for state communication, never for decoration.

### Core Backgrounds

- #EFF1F5 - Page Background (Base)
- #E6E9EF - Sidebar, Card Background (Mantle)
- #DCE0E8 - Surface Tint (Crust)

### Text Colors

- #4C4F69 - Text Primary
- #5C5F77 - Text Light (descriptions)
- #7C7F93 - Text Secondary (labels, inactive nav)
- #9CA0B0 - Text Tertiary (inactive numbers, dismiss icons)

### Accent Colors

- #DF8E1D - Amber Primary (active states, CTAs, charts, indicators)
- #DF8E1D26 - Amber Tint 15% (active nav background)
- #DF8E1D1A - Amber Tint 10% (banner/upgrade backgrounds)
- #DF8E1D4D - Amber Tint 30% (subtle stroke)

### Semantic Colors

- #40A02B - Success (positive changes, completed)
- #DF8E1D - Warning (pending states)
- #D20F39 - Error (negative changes, failures)
- #1E66F5 - Info (new items, informational)

### Borders

- #9CA0B0 - Default Border
- #DF8E1D - Accent Border (active states, left-edge highlights)
...
- #4C4F69 - On Amber Fill (dark for contrast)
- #4C4F69 - Active/Primary
- #9CA0B0 - Inactive
- #7C7F93 - Muted
- Semantic - #40A02B, #D20F39, #DF8E1D, #1E66F5
...
- Use amber primarily for emphasis backgrounds, edge indicators, and borders. For dense text, prefer primary and secondary neutrals.
