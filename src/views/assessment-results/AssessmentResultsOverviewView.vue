<template>
  <div class="p-6">
    <div class="mb-6">
      <h2 class="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-4">
        Metadata
      </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-900 dark:text-slate-200">
            {{ assessmentResults.metadata?.title }}
          </p>
        </div>
        ...
        <div>
          ...
          >
          <p class="mt-1 text-sm text-gray-900 dark:text-slate-200">
            {{ assessmentResults.metadata?.version }}
          </p>
        </div>
        ...
        <div>
          ...
          >
          <p class="mt-1 text-sm text-gray-900 dark:text-slate-200">
            {{ formatDate(assessmentResults.metadata?.published) }}
          </p>
        </div>
        ...
        <div>
          ...
          >
          <p class="mt-1 text-sm text-gray-900 dark:text-slate-200">
            {{ formatDate(assessmentResults.metadata?.lastModified) }}
          </p>
        </div>
        ...
        <div>
          ...
          >
          <p class="mt-1 text-sm text-gray-900 dark:text-slate-200">
            {{ assessmentResults.metadata?.oscalVersion || '1.1.3' }}
          </p>
        </div>
        ...
        <div>
          ...
          >
          <p
            class="mt-1 text-sm text-gray-900 dark:text-slate-200 font-mono text-xs"
          >
      ...
      <div class="mt-4" v-if="assessmentResults.metadata?.remarks">
        ...
        >
          {{ assessmentResults.metadata.remarks }}
        </p>
      </div>
    </div>
