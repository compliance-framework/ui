  ...
  <div class="p-6">
    ...
    <div v-if="loading" class="text-center py-8">
      <p class="text-gray-500 dark:text-slate-400">
        Loading local definitions data...
      </p>
    </div>

    <div v-else-if="error" class="text-center py-8">
      <p class="text-red-500">
        Error loading local definitions data: {{ error }}
      </p>
    </div>

    <div
      v-else-if="localDefinitions"
      ...
      <div class="space-y-6">
        ...
        <div
          v-if="
            ...
            localDefinitions.components.length > 0
          "
        >
          <h3
            class="text-lg font-medium text-gray-900 dark:text-slate-300 mb-3"
          >
            Components
          </h3>
          <div class="space-y-3">
            ...
            >
              ...
              <p
                ...
                class="text-sm text-gray-600 dark:text-slate-400 mb-2"
              >
        ...
        <div
          v-if="
            localDefinitions.inventoryItems &&
            localDefinitions.inventoryItems.length > 0
          "
        >
          <h3
            class="text-lg font-medium text-gray-900 dark:text-slate-300 mb-3"
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <p
                v-if="item.remarks"
                class="text-sm text-gray-600 dark:text-slate-400 mt-2 italic"
              >
                {{ item.remarks }}
              </p>
            </div>
        ...
        <div
          v-if="
            localDefinitions.assessmentAssets &&
            localDefinitions.assessmentAssets.components &&
            localDefinitions.assessmentAssets.components.length > 0
          "
        >
          <h3
            class="text-lg font-medium text-gray-900 dark:text-slate-300 mb-3"
          ...
          <div class="space-y-3">
            <div class="p-4 bg-gray-50 dark:bg-slate-800 rounded border">
              <h4 class="font-medium text-gray-900 dark:text-slate-300 mb-3">
                Components
              </h4>
              <div class="space-y-2">
                <div
                  v-for="(component, index) in localDefinitions.assessmentAssets
                    .components"
                  :key="index"
                ...
                >
                  <div class="flex justify-between items-start">
                    ...
                    <span
                      class="text-xs px-2 py-1 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded"
                    >
                      Assessment
                    </span>
                  </div>
        ...
        <div
          v-if="
            !localDefinitions.components?.length &&
            !localDefinitions.inventoryItems?.length &&
            !localDefinitions.assessmentAssets?.components?.length &&
            !localDefinitions.remarks
          "
          class="text-center py-8"
        >
          <p class="text-gray-500 dark:text-slate-400">
            No local definitions data available.
          </p>
        </div>
      </div>
    </div>
