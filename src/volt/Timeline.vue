...
const theme = ref<TimelinePassThroughOptions>({
    ...
    eventOpposite: props.hideOpposite ? `` : `flex-1` + `
    ...
    eventMarker: `inline-flex items-center justify-center relative self-baseline
        border-2 rounded-full border-ccf-400 dark:border-slate-700 w-[1.125rem] h-[1.125rem]
        bg-surface-0 dark:bg-slate-800
        ...
        p-horizontal:flex-row`,
    eventConnector: `flex-grow bg-ccf-400 dark:bg-slate-700
        p-vertical:w-[2px]
