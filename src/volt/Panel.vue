...
const theme = ref<PanelPassThroughOptions>({
  ...
  transition: {
    ...
    enterActiveClass:
      'overflow-hidden transition-[max-height] duration-300 ease-[cubic-bezier(0.42,0,0.58,1)]',
    enterToClass: 'max-h-[1000px]',
    leaveFromClass: 'max-h-[1000px]',
    leaveActiveClass:
      'overflow-hidden transition-[max-height] duration-200 ease-[cubic-bezier(0,1,0,1)]',
