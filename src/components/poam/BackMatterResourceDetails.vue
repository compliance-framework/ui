  ...
  <div class="space-y-6">
    ...
    <div v-if="resource.uuid" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="md:col-span-2">
        <code class="text-sm bg-gray-100 dark:bg-slate-700 px-2 py-1 rounded text-gray-800 dark:text-slate-300">{{ resource.uuid }}</code>
      </div>
    </div>
    ...
    <div v-if="resource.title" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="md:col-span-2">
        <p class="text-sm text-gray-900 dark:text-slate-300">{{ resource.title }}</p>
      </div>
    </div>

    <!-- Description -->
    <div v-if="resource.description" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="md:col-span-1">
        <h4 class="text-sm font-medium text-gray-700 dark:text-slate-400 mb-1">Description</h4>
      </div>
      <div class="md:col-span-2">
        <p class="text-sm text-gray-900 dark:text-slate-300 whitespace-pre-wrap">{{ resource.description }}</p>
      </div>
    </div>

    <!-- Document IDs -->
    <div v-if="resource.documentIds?.length" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="md:col-span-1">
        <h4 class="text-sm font-medium text-gray-700 dark:text-slate-400 mb-1">Document Identifiers</h4>
      </div>
      <div class="md:col-span-2">
        <div class="space-y-2">
          <div
          ...
          >
            <span v-if="docId.scheme" class="font-medium text-gray-600 dark:text-slate-400">{{ docId.scheme }}:</span>
            <span class="text-gray-900 dark:text-slate-300">{{ docId.identifier }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Citation -->
    <div v-if="resource.citation?.text" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="md:col-span-1">
        <h4 class="text-sm font-medium text-gray-700 dark:text-slate-400 mb-1">Citation</h4>
      </div>
      <div class="md:col-span-2">
    ...
    <!-- External Links -->
    <div v-if="resource.rlinks?.length" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="md:col-span-1">
        <h4 class="text-sm font-medium text-gray-700 dark:text-slate-400 mb-1">External Links</h4>
      </div>
      <div class="md:col-span-2">
        <div class="space-y-2">
          <div
    ...
    <!-- Base64 Content -->
    <div v-if="resource.base64?.value" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="md:col-span-1">
        <h4 class="text-sm font-medium text-gray-700 dark:text-slate-400 mb-1">Embedded Content</h4>
      </div>
      <div class="md:col-span-2">
        <div class="bg-gray-50 dark:bg-slate-800 rounded-md p-3">
    ...
    <!-- Properties -->
    <div v-if="resource.props?.length" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="md:col-span-1">
