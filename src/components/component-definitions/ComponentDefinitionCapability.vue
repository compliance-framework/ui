    ...
    >
      <div class="flex items-start justify-between gap-4">
        <div class="grow">
          ...
          <div
            v-if="capability.incorporatesComponents?.length ?? 0 > 0"
            class="mb-4"
          >
            <h4 class="font-medium text-gray-900 dark:text-slate-300 mb-2">
          ...
          <div
            v-if="capability.controlImplementations?.length ?? 0 > 0"
            class="mb-4"
          >
            <h4 class="font-medium text-gray-900 dark:text-slate-300 mb-2">
          ...
          <table class="table-auto w-full">
            <tbody>
              ...
              >
                ...
                <td class="px-2 py-1">
                  {{ capability.incorporatesComponents?.length }}
                </td>
              </tr>
              <tr
                class="border-t dark:border-slate-700"
              ...
              >
                ...
                <td class="px-2 py-1">
                  {{ capability.controlImplementations?.length }}
                </td>
              </tr>
            </tbody>
          </table>
