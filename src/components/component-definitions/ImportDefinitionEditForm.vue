<template>
  <form @submit.prevent="updateImportDefinition()">
    <h1 class="text-xl font-semibold mb-6 dark:text-slate-300">Edit Import Definition</h1>

    <div class="mb-4">
      <label class="inline-block pb-2 dark:text-slate-300">HREF <span class="text-red-500">*</span></label>
      <FormInput v-model="importDefData.href" placeholder="e.g., https://example.com/definition.json" required />
    </div>

    <div class="mb-4">
      <label class="inline-block pb-2 dark:text-slate-300">Include All Components</label>
      <div class="flex items-center">
        ...
        />
        <span class="text-sm dark:text-slate-400">Include all components from this definition</span>
      </div>
    </div>
